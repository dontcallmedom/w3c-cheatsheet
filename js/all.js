...
Cheatsheet.prototype.load_keyword_data=function(A,B,C){if(inMemory&&keywordsMatch[A]&&(!B||(keywordsMatch[A][B]&&keywordsMatch[A][B][C]))){this.display_keyword_data(keywordsMatch[A],B,C)
}else{$.getJSON("data/json/"+escape(A).toLowerCase()+".js",function(D){this.display_keyword_data(D,B,C)
})
}};
