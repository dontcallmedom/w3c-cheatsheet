...
}function l(z){var y=document.createElement("ul");
var w=z.length;
if((T.maxItemsToShow>0)&&(T.maxItemsToShow<w)){w=T.maxItemsToShow
}for(var x=0;
x<w;
x++){var AA=z[x];
if(!AA){continue
...
y.appendChild(u);
$(u).hover(function(){$("li",y).removeClass("ac_over");
